...
class NFSeISSWeb extends NFSe {
	...
	/**
	 * O par�metro de configura��o deve ser um array com pelo menos as posi��es:
	 ...
	 * $aConfig['descontoIncondicionado'] => (boolean), caso true o campo desconto incondicionado ser� informado no XML, essa configura��o depende se a prefeitura permite descontos incondicionados padr�o false
	 *
	 * @see NFSe
	 *
	 * @param array $aConfig
	...
	/**
	 * Cancela uma Nota Fiscal Eletr�nica
	 *
	...
	/**
	 * Consulta de notas fiscais eletr�nicas
	 *
	...
	public function consultaNFSe(NFSeISSWebConsultarNFSe $oConsultarNFSe){
		//FIXME: fazer consulta com padr�o issweb
		$document = new NFSeDocument();
		...
		if($oConsultarNFSe->Tomador->getCpfCnpj() != ""){
			...
			//Inscri��o Municipal s� deve ser informada para pessoa jur�dica
	...
	/**
	 * Consulta Nota fiscal elet�nica por RPS
	 *
	...
	public function consultarLoteRps($protocolo){
		...
		//FIXME: Fazer metodo com o padr�o ISSWEB
		$document = new NFSeDocument();
	...
	/**
	 * Retorna o XML de uma requisi��o SOAP
	 *
	 * @param string $xml
	 * @param string $action
	 * @param boolean $head
	...
	public function enviarLoteRps(array $aListaRps, NFSeISSWebLoteRps $oLote){
		...
		//FIXME: Fazer envio de lote com o padr�o ISSWEB
	...
	/**
	 * Seta Url do servidor de produ��o: http://canedo.bsit-br.com.br/integracao/services/nfseWS?wsdl
	 *
